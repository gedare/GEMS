 ...
 *
 * Description: 
 * See Tourmaline_Global.h
 * 
 * $Id: Tourmaline_Global.C 1.00 05/11/09 14:02:03-05:00 gibson@mustardseed.cs.wisc.edu $
 *
 */
...
// This is the single, global TransactionController object
TransactionController * g_trans_control = NULL;
Profiler * g_profiler = NULL;

// prints error messages using the (arcane) vfprintf
