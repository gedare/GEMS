...
#ifdef NO_HTM
inline bool begin_transaction_inl() {
  return false;
}

inline void commit_transaction_inl() {
  ;
}

inline void abort_transaction_inl() {
  ;
}
#else

extern "C"
int begin_transaction_inl();

extern "C"
void commit_transaction_inl();

extern "C"
void abort_transaction_inl();
