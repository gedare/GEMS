 ...
 *
 * Description: 
 * Provides bootstrapping and startup code for Tourmaline module. Called
 * largely from tourmaline.c at module startup, though indirectly through
 * the parser after the "init" command has been given.
 * 
 * $Id: init.h 1.00 05/11/09 14:02:03-05:00 gibson@mustardseed.cs.wisc.edu $
 *
 */
