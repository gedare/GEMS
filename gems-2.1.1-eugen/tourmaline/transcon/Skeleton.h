 ...
 *
 * Description:
 * A template from which new Transaction Controllers can be created. DOES NOT
 * have an entry in TransactionControllerTypes, nor does it IN ANY WAY guarantee
 * transactional properties. 
 * 
 * $Id: Skeleton.h 1.00 05/11/09 14:02:03-05:00 gibson@mustardseed.cs.wisc.edu $
 *
 */
...
class Skeleton : public TransactionController {
public:
  Skeleton();
  ~Skeleton();
